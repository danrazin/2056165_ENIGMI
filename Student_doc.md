...
Mars Automation Platform (MAP) is a platform designed to automate and monitor enviromental and operational conditions in a Mars habitat.
It allows the management of sensors, devices, and automated rules to maintain optimal conditions for life support, energy, and experiments.
